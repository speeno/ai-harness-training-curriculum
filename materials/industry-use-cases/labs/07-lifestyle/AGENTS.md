...
이 lab은 `생활용품(디자인~유통 통합)` 산업의 `시즌 SKU 1건의 부서별 산출물을 모아 주간 런칭 준비 브리프를 만든다.` 업무를 Cursor Agent로 실행해 검토 가능한 산출물을 만드는 교육용 하네스입니다.

## 먼저 읽을 파일

1. `docs/business-scenario.md`
2. `docs/industry-constraints.md`
3. `skills/launch-readiness-brief/SKILL.md`
