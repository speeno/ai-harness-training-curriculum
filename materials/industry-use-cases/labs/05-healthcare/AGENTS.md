...
이 lab은 `병원·헬스케어 운영` 산업의 `예약 변경 요청과 민원을 유형별로 분류하고 에스컬레이션 초안을 만든다.` 업무를 Cursor Agent로 실행해 검토 가능한 산출물을 만드는 교육용 하네스입니다.

## 먼저 읽을 파일

1. `docs/business-scenario.md`
2. `docs/industry-constraints.md`
3. `skills/appointment-complaint-triage/SKILL.md`
