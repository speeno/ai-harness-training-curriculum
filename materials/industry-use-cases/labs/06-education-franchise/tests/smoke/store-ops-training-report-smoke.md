# Smoke Verification: store-ops-training-report

| Check | Expected | Result |
| --- | --- | --- |
| Output exists | `workspace/out/store-ops-training-report-draft.md` 또는 `workspace/out/store-ops-training-report-v1.md`가 있다 | [ ] |
...
| Human review | 다음 항목이 검토 필요로 표시되었다: 지점 평가를 단정적으로 표현, 개별 강사·학생 정보 노출, 교육 품질 문제 과장 | [ ] |
