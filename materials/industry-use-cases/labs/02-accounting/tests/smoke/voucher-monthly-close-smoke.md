# Smoke Verification: voucher-monthly-close

| Check | Expected | Result |
| --- | --- | --- |
| Output exists | `workspace/out/voucher-monthly-close-draft.md` 또는 `workspace/out/voucher-monthly-close-v1.md`가 있다 | [ ] |
...
| Human review | 다음 항목이 검토 필요로 표시되었다: 세무 판단 자동 확정, 민감 금액 외부 노출, 고객에게 단정적 안내 발송 | [ ] |
